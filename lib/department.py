...
class Department:
    ...
    @classmethod
    def get_all(cls):
        """Return a list containing a Department onject per row in the table"""
        sql = """
            SELECT *
            FROM departments 
        """
    ...
    def find_by_name(cls, name):
        """Return a Department object corresponding to the first table row matching specified name"""
        sql = """
            SELECT * 
            FROM departments
            WHERE name is ?
